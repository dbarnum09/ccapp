...
//       return $http.get(url);
//     }
//     //http://api.wunderground.com/api/<%= key %>/history_YYYYMMDD/q/<%= latitude %>,<%= longitude %>.json'
//     //http://api.wunderground.com/api/b56db60a3d9ab1ee/history_19980814/q/43.905984,-74.946327.json'
